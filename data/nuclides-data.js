...
const NUCLIDE_DATA = {
  ...
  "nuclides": [
    ...
    },
    {
      ...
      "e_max_beta_MeV": 1.8,
      "cornejo_validation": {
        "gamma_H10_Cornejo": 157,
        "gamma_H007_Cornejo": 157
      },
    ...
    },
    {
      ...
      "source": "ICRP 107 (photon data) / ICRU 57 (conversion coefficients); H'(0.07) calculated, not from Cornejo et al.",
    ...
    },
    {
      ...
      "source": "ICRP 107 (photon data) / ICRU 57 (conversion coefficients); note: calculated value (7.77) differs from Cornejo et al. 2006 (3.86) due to updated nuclear data in ICRP 107",
      "clearance_a1_kBq_per_kg": 1000,

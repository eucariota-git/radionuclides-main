...
function main() {
  ...
  // Special case: Y-90 has no applicable photon dose-rate constant. Container-
  // dependent bremsstrahlung estimates live only in PHYSICS.Y90_CONTAINERS.
  const y90 = nuclides.find(n => n.id === 'Y-90');
  if (y90) {
    y90.gamma_H10 = null;
    y90.gamma_H007 = null;
    y90.source = 'Not applicable — pure β⁻ emitter; see the experimental container-dependent bremsstrahlung scenario in Dose';
